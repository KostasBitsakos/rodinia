...
int main(int argc, char** argv)
{
	...
	mem_alloc_bytes = sizeof(cl_int) * (size + cols + 16384);
#endif
	...
	h2d_bytes += sizeof(cl_int) * (size + 16384);
#endif
